...
BYTE keyMx[CHANNELS] = {0x18,0x1A,0x12,0x10};
//Ключи регистра прерываний
BYTE keyIrq[CHANNELS] = {0,3,1,2};
//Структуры
...
WORD trapFlags[CHANNELS] = {0,0,0,0};              // channel's trap flags
WORD messageFlags[CHANNELS] = {0,0,0,0};           // channel's message flags
BYTE existInt[CHANNELS] = {0,0,0,0};               // UART is existing
HTIMEOUT hTimeState[CHANNELS] = {0,0,0,0};         // state timeout handlers
HTIMEOUT hTimePulse[CHANNELS] = {0,0,0,0};         // pulse timeout handlers
